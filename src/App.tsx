    ...
    <AppProvider>
      <ErrorBoundary>
        <HashRouter>
          ...
          <Route path="/admin/products" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminProductsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/categories" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminCategoriesPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/departments" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminDepartmentsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/teams" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminTeamsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/agents" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminAgentsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/users" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminUsersPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/sla" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminSLAPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/workflows" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminWorkflowsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/automations" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminAutomationsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/knowledge-bases" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminKnowledgeBasesPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/api-clients" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminAPIClientsPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/webhooks" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER']}><Layout><AdminWebhooksPage /></Layout></ProtectedRoute>} />
          <Route path="/admin/audit-logs" element={<ProtectedRoute allowedRoles={['ADMIN', 'OWNER', 'MANAGER']}><Layout><AdminAuditLogsPage /></Layout></ProtectedRoute>} />
